...
<body>   
    ...
    <main>
        <div class="deletarContaDiv">
            <span>Tem certeza que deseja deletar sua conta ?</span>
            <div class="opcoesDeletarConta">
                <a href="../deletarConta.php">Sim</a>
                <button type="button" class="naoDeletarContaBtn">Não</button>
            </div>
        </div>
        <section id="dadosCadastrais" class="twoGrid margin">
            <div class="left">
                ...
                <a href="./dadosCadastraisPages/geral.php" class="dadosCadastraisContainer">
                    <div class="dadosCadastraisContent">

                        <i class="bi bi-person-bounding-box"></i>
                        <div class="dadosCadastraisText">
                            <h2>Dados pessoais</h2>
                            <span>Aqui você encontra todas as suas informações e dados pessoais.</span>
                        </div>
                    </div>
                </a>
                
                <hr>
                <button type="button" class="dadosCadastraisContainer deletarContaBtn">
                    <div class="dadosCadastraisContent">

                        <i class="bi bi-trash"></i>
                        <div class="dadosCadastraisText">
                            <h2>Quero deletar minha Conta</h2>
                            <span>Ao clicar aqui você deleta a sua conta atual</span>
                        </div>
                    </div>
                </button>
                <hr>
