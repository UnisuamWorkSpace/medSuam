...
<body>   
    ...
    <aside>
        ...
        <ul>
            ...
            <li>
                <a href="./vacinas.php" class="linkPage currentPage">
    ...
    <main>
        <section id="vacinas" class="margin twoGrid hideableDiv"> 
            <div class="left">
            <h1>Seus Atalhos</h1>
            <div class="twoCards">
            ...
            <div class="alterPacientContainer vacinasAlterPacientContainer">
                <button type="button" id="alterPacientBtn2" class="alterPacientBtn">
                    <strong>Nome</strong>
                    <span>• Alterar</span>
